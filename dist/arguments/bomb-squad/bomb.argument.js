...
const bomb_exception_1 = require("../../traps/exceptions/bomb.exception");
const bomb_trap_1 = require("../../traps/bomb-squad/bomb.trap");
let BombArgument = class BombArgument {
    execute(bombType) {
        bombType = bombType;
        if (bombType == 'c4' || bombType == 'hydrogen') {
            throw new bomb_exception_1.DudBombException();
        }
        else {
            throw new bomb_exception_1.BombNotFoundException();
        }
    }
};
__decorate([
...
BombArgument = __decorate([
    ...
    common_1.UseTraps(bomb_trap_1.BombCommandTrap)
], BombArgument);
